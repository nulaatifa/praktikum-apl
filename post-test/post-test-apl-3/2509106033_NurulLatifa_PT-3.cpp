...
void menuSewaFilm() {
    ...
    daftar_sewa[jumlah_sewa].kode_film_sewa   = kode_dipilih;
    daftar_sewa[jumlah_sewa].judul_film_sewa  = daftar_film[indeks_film].judul_film;
    daftar_sewa[jumlah_sewa].harga_per_hari   = daftar_film[indeks_film].harga_sewa;
    daftar_sewa[jumlah_sewa].durasi_hari      = durasi_hari;
    daftar_sewa[jumlah_sewa].tanggal_sewa     = tanggal_sewa;
    daftar_sewa[jumlah_sewa].tanggal_kembali  = tanggal_kembali;
